...
## You can make these as embedded graphs...
...
![Process map](_images/ofsted-mi-process-map.jpg){style="border: 2px solid grey;"}

------------------------------------------------------------------------

## .scrollable

![Targets pipeline](_images/ofsted_targets_pipeline.png){style="border: 2px solid grey;"}
