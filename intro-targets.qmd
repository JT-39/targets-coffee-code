...
- Pure functions:
    - Referentially transparent function is a function that does not use
    any variable that is not also one of its inputs.
    - A function that does not interact in any way with the global environment.
- Functions with only side-effects will be difficult to handle. (base plot())
:::
------------------------------------------------------------------------
